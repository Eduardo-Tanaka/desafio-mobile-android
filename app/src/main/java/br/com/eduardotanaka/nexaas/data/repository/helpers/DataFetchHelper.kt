package br.com.eduardotanaka.nexaas.data.repository.helpers

import android.content.SharedPreferences
import androidx.annotation.WorkerThread
import br.com.eduardotanaka.nexaas.data.repository.base.Resource
import br.com.eduardotanaka.nexaas.data.repository.helpers.DataFetchHelper.DataFetchStyle
import br.com.eduardotanaka.nexaas.data.repository.helpers.DataFetchHelper.DataFetchStyle.Result
import br.com.eduardotanaka.nexaas.util.RepositoryUtil
import br.com.eduardotanaka.nexaas.util.onMainThread
                ...
                if (RepositoryUtil.isCacheStale(
                    ...
                    if (resource.data == null) {
                        if (resource.errorMessage == null) {
                            ...
                            log("Error retrieving data from network")
                        }
                    } else {
